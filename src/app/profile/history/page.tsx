    ...
    return (
        <div className="min-h-screen bg-[#FDFDFD] flex flex-col font-sans">
            ...
            <main className="flex-grow container mx-auto px-4 py-12 max-w-6xl">
                <div className="mb-10">
                    <h1 className="text-4xl font-extrabold text-gray-900 tracking-tight">Lịch sử Đơn hàng</h1>
                    <p className="text-gray-500 mt-2 text-lg">Theo dõi các món ăn và lượng calo của bạn</p>
                </div>
                ...
                <div className="grid lg:grid-cols-12 gap-8 items-start">
                    <div className="lg:col-span-8 space-y-6">
                        ...
                        <div className="space-y-4">
                            {filteredOrders.length > 0 ? filteredOrders.map((order) => (
                                <div key={order.id} className="bg-white rounded-3xl p-6 shadow-sm border border-gray-100 hover:shadow-md transition-shadow group">
                                    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-xs font-medium text-gray-400 mt-0.5">{order.date}</p>
                                            </div>
                                        </div>
                                        <div className="flex flex-wrap items-center gap-6">
                                            <div className="flex flex-col items-end">
                                                <span className={`px-3 py-1 rounded-full text-xs font-bold ${order.status === 'Đã hoàn thành' ? 'bg-green-100 text-green-700' :
                                            ...
                                            <div className="grid grid-cols-2 sm:flex items-center gap-8">
                                                ...
                                                <div className="hidden sm:block">
                                                    <p className="text-xs text-gray-400 mb-1">Đạm</p>
                                        ...
                                        <div className="flex gap-3 w-full sm:w-auto mt-4 sm:mt-0">
                                            ...
                                            <Link href={`/order/${order.id}`}>
                                                <Button variant="ghost" className="h-10 w-10 p-0 rounded-xl hover:bg-orange-50 hover:text-orange-500 transition-colors">
                                    ...
                                    <div className="mt-6 pt-6 border-t border-gray-50 flex flex-wrap gap-2">
                                        {order.items.map((item: any, idx: number) => (
                                            <span key={idx} className="px-3 py-1.5 bg-gray-50 text-gray-600 rounded-xl text-xs font-semibold hover:bg-orange-50 hover:text-orange-500 transition-colors cursor-default">
                                                {item.name}
                                            </span>
                                        ))}
                                    </div>
                                ...
                                <div className="bg-white rounded-3xl p-16 text-center border border-gray-100 shadow-sm">
                                    ...
                                    <p className="text-gray-500 mb-8 max-w-xs mx-auto">Bạn chưa đặt món quà nào từ SmartBite. Hãy khám phá thực đơn của chúng tôi!</p>
                                    <Link href="/menu">
                                        <Button className="rounded-2xl bg-[#111827] hover:bg-black text-white px-8 h-12 font-bold shadow-lg shadow-gray-200">
                                            Khám phá thực đơn
                                        </Button>
                                    </Link>
                                </div>
                    ...
                    <div className="lg:col-span-4 space-y-6">
                        <div className="bg-white rounded-3xl p-8 shadow-sm border border-gray-100 relative overflow-hidden group">
                            ...
                            <h2 className="text-xl font-bold text-gray-900 mb-6 relative">Thống kê Calo</h2>
                            <div className="space-y-6 relative">
                                <div className="flex items-end gap-1">
                                    <span className="text-5xl font-black text-orange-500 leading-none">1.700</span>
                                    <span className="text-gray-400 font-bold text-sm mb-1 uppercase tracking-widest">KCAL</span>
                                </div>
                                <div className="w-full h-3 bg-gray-100 rounded-full overflow-hidden shadow-inner">
                                    <div className="w-[85%] h-full bg-gradient-to-r from-orange-400 to-orange-500 rounded-full relative">
                                ...
                                <div className="flex justify-between items-center mt-8 pt-4 border-t border-gray-50">
                                    <span className="text-xs font-medium text-gray-500">Mục tiêu: 2000 kcal</span>
                                    <span className="text-xs font-bold text-green-500 tracking-wide">Đạt 85%</span>
                                </div>
                            </div>
                        </div>

                        <div className="bg-white rounded-3xl p-8 shadow-sm border border-gray-100">
                            <h2 className="text-xl font-bold text-gray-900 mb-6">Dinh dưỡng đã dùng</h2>
                            <div className="space-y-5">
                                <div className="flex flex-col gap-2">
                                    <div className="flex justify-between text-sm">
                                        <span className="text-gray-500 font-medium">Chất đạm</span>
                                ...
                                <div className="flex flex-col gap-2">
                                    <div className="flex justify-between text-sm">
                                        <span className="text-gray-500 font-medium">Tinh bột</span>
                                ...
                                <div className="flex flex-col gap-2">
                                    <div className="flex justify-between text-sm">
                                        <span className="text-gray-500 font-medium">Chất béo</span>
                        ...
                        <div className="bg-[#111827] rounded-3xl p-8 shadow-lg shadow-gray-200 text-white relative overflow-hidden group">
                            ...
                            <Button className="w-full bg-white text-gray-900 hover:bg-gray-100 font-bold rounded-2xl h-12 shadow-md">
